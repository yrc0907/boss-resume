...
/** 所有平台适配器的唯一注册入口。 */
export const PLATFORM_ADAPTERS: PlatformAdapter[] = [zhipinAdapter, zhaopinAdapter, fiftyOneJobAdapter, liepinAdapter, shixisengAdapter, nowcoderAdapter, yingjieshengAdapter, iguopinAdapter, lagouAdapter, fiftyEightAdapter, maimaiAdapter];
